...
public class StringCompressor {
     ...
     *
     * <p>Begin with an empty string s. Foreach group of consecutive repeating characters in chars:
     * If the group's length is 1, append character to s. Otherwise append the character followed
     * by the group's length. Return a compressed string.
     *
     * <p>Follow up: Could you solve it using only O(1) extra space?
     *
     * <p>Examples: a->a aa->a2 aaa->a3 aaabb->a3b2 ""->"" null->Illegal argument 234 sdf
     * -> Illegal argument
     *
